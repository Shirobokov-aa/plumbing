        ...
        <section>
          <div className="lg:block hidden max-w-1440 mx-auto lg:px-24 px-5 pt-24">
            <div className="relative w-full xl:h-[780px]">
              <Image
                src={typeof sections["section-2"]?.images?.[0] === 'string'
                  ? sections["section-2"].images[0]
                  : sections["section-2"]?.images?.[0]?.src || "/img/fallback-image.png"}
                alt="Banner image"
                width={1240}
                height={780}
                className="object-contain"
          ...
          <div className="max-w-1440 mx-auto lg:px-24 px-5 pt-24">
            <div className="flex xl:flex-row flex-col-reverse xl:gap-24 gap-5">
              <div className="xl:max-w-[526px] w-full">
                <Image
                  src={typeof sections["section-3"]?.images?.[0] === 'string'
                    ? sections["section-3"].images[0]
                    : sections["section-3"]?.images?.[0]?.src || "/img/fallback-image.png"}
                  alt="Section image"
                  width={526}
                  height={526}
                  className="object-contain"
